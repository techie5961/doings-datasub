   ...
   <span class="c-primary">Here's what's happening today.</span>
    ...
    <div style="border:1px solid var(--rgt-01)" class="w-full analytic bg-light p-20 br-20 column g-10">
        <div class="row g-10 align-center space-between w-full">
            ...
            <span class="c-primary opacity-02">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="CurrentColor" height="30" width="30"><path d="M200,40H168a16,16,0,0,0-16-16H32A16,16,0,0,0,16,40v80a16,16,0,0,0,16,16h8v64a16,16,0,0,0,16,16H200a16,16,0,0,0,16-16V56A16,16,0,0,0,200,40ZM106.34,61.66a8,8,0,0,1,11.32-11.32l24,24a8,8,0,0,1,0,11.32l-24,24a8,8,0,0,1-11.32-11.32L124.69,80Zm-64,24a8,8,0,0,1,0-11.32l24-24A8,8,0,0,1,77.66,61.66L59.31,80,77.66,98.34a8,8,0,0,1-11.32,11.32ZM200,200H56V136h96a16,16,0,0,0,16-16V56h32Z"></path></svg>
            </span>
        </div>
        <div onclick="window.location.href='{{ url('admins/api/management') }}'" class="w-fit p-5 p-x-10 bg-primary pointer no-select primary-text">Click to Manage</div>
