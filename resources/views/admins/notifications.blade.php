       ...
       @else
           <div class="grid w-full g-10 pc-grid-2 place-center">
             ...
             {{-- new row --}}
                ...
                <div style="background:var(--rgt-01)" class="w-40 circle perfect-square no-shrink column align-center justify-center">
                    @isset($data->icon)
                        {!! $data->icon !!}
                        @else 
             ...
             {{-- new row --}}
             <div class="p-5 p-x-10 br-1000 w-fit g-5 row align-center justify-center" style="background:var(--rgt-01);color:var(--rgt-08)">
               <span class="h-fit column">
