 ...
 <section class="w-full chat-section column g-10">
    ...
    <div class="messages">
        <div class="message-div">
            Hi {{ explode(' ',ucfirst(Auth::guard('users')->user()->name))[0] }}! 👋 Welcome to {{ config('app.name') }}. How can I help you today? Whether you need help with data top-ups, airtime purchase, transaction issues, or payment confirmation — just let me know. I'm here to get it sorted for you quickly.

        </div>
        @if (!$chats->isEmpty())
      @foreach ($chats as $data)
            <div class="message-div {{ $data->sent_by }}">
