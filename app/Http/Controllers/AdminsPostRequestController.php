...
class AdminsPostRequestController extends Controller
{
    ...
    public function SocialSettings(){
        ...
        'twitter_community' => request('twitter_community') ?? '',
        'facebook_community' => request('facebook_community') ?? '',
        'instagram_community' => request('instagram_community') ?? '',
    ...
    public function ContactSettings(){
        $message='Contact settings updated success';
